...
const Index = ({ auth, bookings, success, error }: any) => {
    ...
    const changeBrandStatus = (id: number, status: number) => {
        Inertia.get(route("admin.inspections.status", { id, status }));
      };
    return (
        <>
     
        <Head title="Buy Booking | List"/>
            <div className="container-fluid">
                ...
                <h1 className="h3 mb-2 text-gray-800">Buy Inspection Details</h1>
