...
const Footer = () => {
    return (
        <>
            ...
            <footer className="bg-sky-200 dark:bg-gray-900 mt-32">
                <div className="mx-auto w-full max-w-screen-xl">
                    <div className="grid grid-cols-1 gap-8 px-4 lg:py-8 md:grid-cols-4">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Company</h2>
                            <p>Cu qui probo malorum saperet. Ne admodum apeirian iracundia usu, eam cu agam ludus.</p>
                            <div className="flex mt-5 space-x-6  md:mt-0">
                                <a href="#" className="text-gray-400 hover:text-gray-900 dark:hover:text-white mt-4">
                ...
                <div className="px-4 py-6 bg-sky-200 flex justify-center lg:flex lg:justify-center dark:bg-gray-700 md:flex md:items-center md:justify-between">
