                ...
                <div className="mx-auto max-w-screen-xl w-full h-full mt-12 ">
                    ...
                    <div className="flex flex-col justify-center md:flex-row mx-8">
                        ...
                        <div className="md:w-2/3 ll-2 lg:pl-28">
                            ...
                            <p className='text-gray-900 text-lg border-b border-gray-950 pb-4 mb-2'>
                                Carswap.ng is Nigeria's first largest car swap marketplace launched in 2018 and incorporated in Nigeria as Carswap Limited. It promises to make car ownership seamless among users.
                                <br/><br/>
