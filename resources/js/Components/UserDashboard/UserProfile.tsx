                ...
                <div className="p-4">
                    ...
                    <div className="bg-white border border-gray-300 rounded-lg shadow-md p-4 mb-4">
                        <div className="flex flex-col items-center mb-4">
                            ...
                            <p className="text-gray-900 mt-1"><b>Email:</b> johnny@xyz.com</p>
                            <p className="text-gray-900 mt-1"><b>Contact:</b> 37612790123</p>
                        </div>
                        <div className="flex flex-col">
                            <button className="underline hover: text-dark font-medium mb-2">
                                Edit Profile
                            </button>
                            <button className="underline hover: text-dark font-medium mb-2">
                                Liked Ads
