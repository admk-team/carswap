    ...
    return (
        <>
            <div className='' style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover' }}>
                <div className="top-0 w-full min-h-[14rem] mt-3 ">
                    <div className="container flex flex-col lg:flex-row items-center xl:gap-y-12 xl:gap-x-80 lg:gap-x-32 mx-auto max-w-7xl px-4">
                        ...
                        <div className="ml-80 mt-10 xl:ml-0 xl:my-48 hidden md:block"  >
                            ...
                            <p className='text-lg text-black ml-10 font-bold'>A. UPGRADE: Here, a customer uses an existing car to buy their dream car by simply using our Swap calculator.<br/>
